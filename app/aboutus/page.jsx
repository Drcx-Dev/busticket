...
export default function AboutUs() {
  return (
    <main className="text-black">
      <section>
        <div>
          <h1 className="text-center text-3xl font-bold pt-7">О компании</h1>
        </div>
        <div className="flex flex-col md:flex-row justify-center mt-14">
          <div className="w-full md:w-[900px] bg-white rounded-s-lg shadow-2xl p-5">
      ...
      <section>
        <div className="flex justify-center mt-20 flex-wrap">
          ...
          <div className="w-full sm:w-[900px] bg-white space-y-3 pt-10 pl-5 shadow-2xl rounded-e-xl">
