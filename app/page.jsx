    ...
    <main>
      <section className="mt-20">
        <div className="bg-white container w-[1400px] justify-self-center mt-4 rounded-md h-[639px] flex">
          <div className="text-6xl pt-36 pl-4 text-black">
            <h1>
              Вип-экспресс - <br />
              ваш комфорт
              <br /> в любом месте!
            ...
            <button className="text-xl bg-indigo-500 w-48 h-12 rounded-md text-white hover:bg-indigo-400">
              <Link href="./schedule">покупка билетов</Link>
            </button>
          </div>
      ...
      <section className="mt-20 ">
        <h1 className="text-4xl justify-self-center text-black">
          Ежедневные рейсы
        </h1>
        <div className="flex justify-center space-x-8 text-center pt-10">
          <div className="w-[520px] h-10 rounded-md pt-2 bg-indigo-400 text-white">
            <h1>Москва (Автовокзал Саларьево) - Волжский / Волгоград</h1>
          </div>
          <div className="w-[520px] h-10 rounded-md pt-2 pr-6 bg-indigo-400 text-white">
      ...
      <section className="mt-20">
        <div className="flex flex-wrap md:flex-nowrap">
          <div className="bg-white w-full md:w-[1000px] md:ml-20 rounded-s-md p-4 text-black">
            ...
            <button className="text-xl bg-indigo-500 w-48 h-10 mt-2 rounded-md text-white hover:bg-indigo-400">
              <Link href="./aboutus">подробнее о нас</Link>
            </button>
          </div>
      ...
      <section>
        <h1 className="text-center text-3xl font-bold mt-2 text-black">
          Отзывы клиентов
        </h1>
        <div className="flex flex-wrap justify-center gap-8 mt-8">
          <div className="w-full sm:w-[480px] bg-white p-6 rounded-xl shadow-lg text-black">
            <p className="text-sm text-black">г.Москва</p>
          ...
          <div className="w-full sm:w-[480px] bg-white p-6 rounded-xl shadow-lg text-black">
            <p className="text-sm text-black">г.Волгоград</p>
            <h1 className="text-2xl font-semibold text-black mt-2">
              Дмитрий Фёдоров
            </h1>
            <p className="mt-4 text-black">
