    ...
    <main>
      <section className="mt-16">
        ...
        <div className="bg-white flex w-[900px] h-[31] justify-self-center mt-8 rounded-md">
          <div className="text-center pt-8 space-y-2 text-black">
      ...
      <section>
        <h1 className="text-4xl font-bold pt-20 text-center text-black">
          Наши адреса
        </h1>
        <div className="">
          <div className="min-h-screen bg-gray-100 flex flex-wrap justify-center gap-4 p-4">
            <div className="max-w-sm p-4 bg-white border rounded-lg shadow-md text-black">
              <h2 className="text-xl font-semibold mb-1">Москва</h2>
              <p className="mb-1 text-xl">
                Адрес: Кожевническая дом 3 стр 1 (Павелецкий Вокзал)
              </p>
              <p className="mb-1 text-xl">Телефон: 8 (925) 429-29-48</p>
              <p className="text-xl">Режим работы: ежедневно с 9:00 до 22:00</p>
            </div>
            <div className="max-w-sm p-4 bg-white border rounded-lg shadow-md text-black">
              <h2 className="text-xl font-semibold mb-1">Волгоград</h2>
              <p className="mb-1 text-xl">Адрес: Коммунистическая дом 16</p>
              <p className="mb-1 text-xl">Телефон: 8 (925) 429-29-48</p>
              <p className="text-xl">Режим работы: ежедневно с 9:00 до 22:00</p>
            </div>
            <div className="max-w-sm p-4 bg-white border rounded-lg shadow-md text-black">
              <h2 className="text-xl font-semibold mb-1">Волжский</h2>
              <p className="mb-1 text-xl">Адрес: ежедневно с 9:00 до 21:00</p>
              <p className="mb-1 text-xl">Телефон: 8 (925) 429-29-48</p>
              <p className="text-xl">Режим работы: ежедневно с 9:00 до 22:00</p>
            </div>
            <div className="max-w-sm p-4 bg-white border rounded-lg shadow-md text-black">
              ...
              <p className="mb-1 text-xl">Адрес:Михайловка (Рижский рынок)</p>
              <p className="mb-1 text-xl">Телефон: 8 (925) 429-29-48</p>
              <p className="text-xl">Режим работы: ежедневно с 9:00 до 22:00</p>
            </div>
            <div className="max-w-sm p-4 bg-white border rounded-lg shadow-md text-black">
